...
//// Function to find senior students who have completed assignments

let seniorStudents = (student:Student []): Student []=> {
...
let filteringStudents = (student: Student []): Student[] => {
